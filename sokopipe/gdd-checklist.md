...
> Scope MVP: 14 level, không key/door, không directional corner.
...
| Connector | Đẩy được, nối route mọi hướng sau khi route bắt đầu từ ống thẳng | [ ] |
...
| Connector (+) | khớp nối đa hướng | bị đẩy, nối/rẽ route sau khi vào từ pipe thẳng |
...
| 2 | 7-11 | Straight Tunnels | Tunnel là shortcut/bridge, tiếp cận vùng/hướng push mới |
| 3 | 12-14 | Connector Tunnels | Connector đa hướng, đổi dọc↔ngang, tự tạo route |

### 3.2 Level Layout
- [ ] 14 level, mỗi level vẽ grid layout (ASCII hoặc hình)
...
3. **Build 14 level** → test difficulty curve
